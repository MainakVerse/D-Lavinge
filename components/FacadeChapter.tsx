...
const video2 = '/media/facade-window.mp4';
const poster2 = '/media/facade-window.jpg';

gsap.registerPlugin(ScrollTrigger);

export default function FacadeChapter() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // pin-exit fade-to-black, which has no pinned space to animate across.
      if (isMobile) {
  ...
  return (
    ...
    >
      <ScrubVideoLayer videoRef={videoRef} src={video2} poster={poster2} />
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div
          ref={textRef}
          className="font-display text-[5vw] md:text-[4vw] font-light tracking-tight text-[#e8e4df] text-center"
        >
          14 Rue de la Solitude, París
        </div>
      </div>
